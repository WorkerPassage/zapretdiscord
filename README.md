...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" alt="Discord" height=28 /> <a href="https://github.com/WorkerPassage/">WorkerPassage</a><a href="https://github.com/WorkerPassage/zapretdiscord">/zapretdiscord</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" alt="YouTube" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `WorkerPassage/zapretdiscord`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/WorkerPassage/zapretdiscord/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/WorkerPassage/zapretdiscord/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/WorkerPassage/zapretdiscord/issues/522)
...
- См. [#765](https://github.com/WorkerPassage/zapretdiscord/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/WorkerPassage/zapretdiscord/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/WorkerPassage/zapretdiscord/discussions/251)
...
- См. также [#252](https://github.com/WorkerPassage/zapretdiscord/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/WorkerPassage/zapretdiscord/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/WorkerPassage/zapretdiscord/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/WorkerPassage/zapretdiscord/blob/main/LICENSE.txt)
